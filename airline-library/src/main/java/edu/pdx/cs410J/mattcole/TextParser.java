...
public class TextParser implements AirlineParser<Airline> {
    ...
    public Airline parse() throws ParserException {
        ...
        } catch (ExceptionHolder.InvalidDateTime e) {
            throw new ParserException("Error parsing date time in file");
        } catch (
                ArrayIndexOutOfBoundsException e) { //Really if we have any sort of error here we should just inform the user of a malformed
            //file
