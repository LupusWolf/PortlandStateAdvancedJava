...
public class XmlDumper implements AirlineDumper<Airline> {
    ...
    public void dump(Airline airline) {
        ...
        try (
            ...
            try {
                ...
                throw new RuntimeException("Parser configuration error: " + ex.getMessage());
    ...
    {
        String value = flight.getFieldByEnum(field); //Use the get field by enum to get the data for this field
