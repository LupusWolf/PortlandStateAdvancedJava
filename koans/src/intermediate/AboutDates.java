...
public class AboutDates {
    ...
    private Date dateFromValues(int year, int month, int day, int hour, int minute, int second)
    {
        try {
    ...
    public void dateToString() {
        assertEquals(date.toString(), dateFromValues(1973,3,3,4,33,21).toString());
    }
    ...
    public void changingDateValue() {
        ...
        assertEquals(date.toString(), dateFromValues(1973,3,3,5,33,21).toString());
    }
    ...
    public void usingCalendarToChangeDates() {
        ...
        assertEquals(cal.getTime().toString(), dateFromValues(1973,4,3,5,33,21).toString());
    }
    ...
    public void usingRollToChangeDatesDoesntWrapOtherFields() {
        ...
        assertEquals(cal.getTime().toString(), dateFromValues(1973,3,3,5,33,21).toString());
    }
