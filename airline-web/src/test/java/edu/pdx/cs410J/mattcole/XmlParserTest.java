...
public class XmlParserTest {
    @Test
    public void simpleTest(@TempDir File tempDir) throws constHolder.ArrivesBeforeDeparts, constHolder.InvalidAirportCode, Flight.FlightParseDateTimeException, IOException, ParserException {
