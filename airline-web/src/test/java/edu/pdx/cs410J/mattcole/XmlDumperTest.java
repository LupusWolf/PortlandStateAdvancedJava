...
public class XmlDumperTest {
    public static Airline createSimpleAirline() throws constHolder.ArrivesBeforeDeparts, constHolder.InvalidAirportCode, Flight.FlightParseDateTimeException {
    ...
    @Test
    public void simpleXMLTest() throws constHolder.ArrivesBeforeDeparts, constHolder.InvalidAirportCode, Flight.FlightParseDateTimeException, IOException {
