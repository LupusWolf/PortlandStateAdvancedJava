...
public class AirlineTest {
     ...
     */
    Airline setupBasicAirline() throws Flight.FlightParseDateTimeException, constHolder.ArrivesBeforeDeparts, constHolder.InvalidAirportCode {
    ...
    @Test
    void testAirlineName() throws constHolder.ArrivesBeforeDeparts, Flight.FlightParseDateTimeException, constHolder.InvalidAirportCode {
     ...
     */
    @Test
    void testAirlineCount() throws constHolder.ArrivesBeforeDeparts, Flight.FlightParseDateTimeException, constHolder.InvalidAirportCode {
        var airline = setupBasicAirline();
     ...
     */
    @Test
    void testAirlineNumber() throws constHolder.ArrivesBeforeDeparts, Flight.FlightParseDateTimeException, constHolder.InvalidAirportCode {
        var airline = setupBasicAirline();
